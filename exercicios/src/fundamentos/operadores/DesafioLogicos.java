...
public class DesafioLogicos {
	public static void main(String[] args) {
		...
		//se os 2 verdadeiros = comprar televisão 50";
		//se um deles for verdadeiro televisão 32";
		//nos 2 vai tomar sorvete;
		//se nenhum for certo, vai não vai tomar sorvete;
		...
		System.out.println("Televisão de 50\"? " + televisao50);
		System.out.println("Televisão de 32\"? " + televisao32);
